 ...
 * @author OscarLopez
 */
public class Mostrar extends javax.swing.JFrame implements KeyListener, MouseListener {
    ...
    private void ponerEschuchar() {
        ...
        this.aiuda1.addMouseListener(this);
        this.aiuda2.addMouseListener(this);
    ...
    public void mouseClicked(MouseEvent e) {
        if(e.getSource() == this.aiuda1){
            JOptionPane.showMessageDialog(null , 
                    "Escriba en el campo de texto, a medida que \n"
                  + "vaya escribiendo él buscador le irá mostrando\n"
                  + "resultados dependiendo de su elección.\n\n Presione Enter para una búsqueda inmediata de lo que haya escrito");
        }
        if(e.getSource() == aiuda2){
            JOptionPane.showMessageDialog(null, "Ingrese en el campo de texto la referencia del ítem que busca\n y presione buscar, enseguida podrá ver y editar el elemento deseado");
        }
    }
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    .addGroup(jPanel2Layout.createSequentialGroup()
                        ...
                        .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                        .addComponent(aiuda2, javax.swing.GroupLayout.PREFERRED_SIZE, 21, javax.swing.GroupLayout.PREFERRED_SIZE))
        ...
        jPanel2Layout.setVerticalGroup(
            ...
            .addGroup(jPanel2Layout.createSequentialGroup()
                .addGroup(jPanel2Layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(aiuda2, javax.swing.GroupLayout.DEFAULT_SIZE, javax.swing.GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                    .addGroup(jPanel2Layout.createSequentialGroup()
    ...
    private javax.swing.JLabel aiuda1;
    private javax.swing.JLabel aiuda2;
